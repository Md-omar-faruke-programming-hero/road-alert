...
const Coursefee = () => {
    ...
    return (
        <div>
            <h3 className="title text-center mb-2">Course fee for Auto private car</h3>
            ...
            <hr />
            <h3 className="title text-center mb-2">Course fee for Manual private car</h3>
            <Row xs={1} md={3} className="g-1 container m-auto mb-2">
            {
            ...
            <hr />
            <h3 className="title text-center mb-2">Course fee for Bike & Scooter</h3>
            <Row xs={1} md={3} className="g-1 container m-auto mb-2">
            {
